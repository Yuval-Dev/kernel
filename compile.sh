...
NASM_COMPILER_PATH="$HOME/opt/cross/bin" #edit as you see fit
QEMU_EXECUTABLE_PATH="$HOME/opt/cross/bin" #edit as you see fit
...
export PATH="$NASM_COMPILER_PATH:$PATH"
export PATH="$QEMU_EXECUTABLE_PATH:$PATH"
export TARGET="i686-elf" #edit as you see fit

nasm -f elf ./asm/*.asm #to compile all the assembly files
#^^^ compile the assembly files

$TARGET-gcc *.cpp ./asm/*.o -o kernel.bin -nostdlib -ffree\
